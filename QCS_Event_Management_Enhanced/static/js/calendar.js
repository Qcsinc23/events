document.addEventListener('DOMContentLoaded', function() {
    ...
    var csvFileSection = document.getElementById('csvFileSection');
    var icsUrlSection = document.getElementById('icsUrlSection');
    if (importType && icsFileSection && csvFileSection && icsUrlSection) {
        importType.addEventListener('change', function() {
            icsFileSection.style.display = (this.value === 'ics_file') ? 'block' : 'none';
            csvFileSection.style.display = (this.value === 'csv_file') ? 'block' : 'none';
